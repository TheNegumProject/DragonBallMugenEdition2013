...
type = ChangeState
value = 10107777
triggerall = command = "energy sword"
trigger1 = (statetype = s) && ctrl
triggerall = power > 2000
;------------------------------------------------------------------------
;teleport atack
[State -1, teleport atack]
type = ChangeState
value = 10099
triggerall = command = "teleport atack"
trigger1 = (statetype = s) && ctrl
...
;------------------------------------------------------------------------
;finalekameha2
[State -1, finalekameha2]
type = ChangeState
value = 101033333
triggerall = command = "finalekameha2"
trigger1 = (statetype = s) && ctrl
...
;------------------------------------------------------------------------
;wyzut przeciwnika
[State -1, wyzut przeciwnika]
type = ChangeState
value = 113232
triggerall = command = "wyzut przeciwnika"
trigger1 = (statetype = s) && ctrl
;------------------------------------------------------------------------
;finalekameha
[State -1, finalekameha]
type = ChangeState
value = 10103333
triggerall = command = "finalekameha"
trigger1 = (statetype = s) && ctrl
triggerall = power > 2000
;------------------------------------------------------------------------
;wyzut
